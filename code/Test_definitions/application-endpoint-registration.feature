...
Feature: CAMARA Application Endpoint Registration API, v0.2.0-rc.1 - Operations for registering application endpoints
...
# References to OAS spec schemas refer to schemas specified in application-endpoint-registration.yaml
  ...
  Background: Common Application Endpoint Registration setup
    ...
    And the resource "/application-endpoint-registration/v0.2rc1"
